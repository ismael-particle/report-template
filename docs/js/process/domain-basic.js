...
document.getElementById('organization_name').innerHTML = service_agreement_obj[0]["DOMAIN"]
document.getElementById('organization_service').innerHTML = 'Domain'

//delete a subtitle
document.getElementById("table_service_agreement").remove();
...
if (iscellular_customer) {
	...
	let cellular_package_recomendation = calculate_package(
		...
		column_average = 'MONTHLY_DATA_OPS_QY');
...
{
	section_id: "table_domains_details", //It is use to the section_i and CSV download_id 
	subtitle: "List of sandbox accounts", //Section subtitle
	tooltip_content: "Sandbox accounts in domain",
	dowload_boolean: true, //true,false
	url_docs: "", //notion url
	content_type: "simple-table", //simple-table,simple-chart,
	table_settings: {   
        //"DOMAIN","USER_EMAIL","FIRST_NAME","LAST_NAME", "CREATION_DATE", "SERVICE_AGREEMENT_ID"
        //"ACCOUNT_STATUS","METERED_DEVICE_LIMIT","DATA_OPERATION_LIMIT","CELLULAR_DATA_LIMIT"
		table_data: service_agreement_obj,
		order_by: [{
			column: "USER_EMAIL",
		  	dir: "desc"
		}], //it could be more that one column
        ...
        {
			title: "Device limit",
			field: "METERED_DEVICE_LIMIT",
			hozAlign: "left",
			width: 120
		},
        {
			title: "Data ops limit",
			field: "DATA_OPERATION_LIMIT",
			hozAlign: "left",
			width: 120
		},
        {
			title: "Cellular data limit",
			field: "CELLULAR_DATA_LIMIT",
			hozAlign: "left",
			width: 120
		}
		]
